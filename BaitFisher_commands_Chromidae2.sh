...
export WD=/Users/jose.carvajal/Desktop/exoncap/Chromodorididae/ChromidaeV2
export REF_GENOME=/Users/jose.carvajal/Desktop/exoncap/corals/RefSeq/GCF_000222465.1_Adig_1.1_genomic.fna
export ALN_DIR=$WD/exon_alns
export BaitFisher_Path=/Users/jose.carvajal/Desktop/Gitclones/BaitFisher-package
export BaitFisherHelper_Path=/Users/jose.carvajal/Desktop/git_repos/BaitFisherHelper
...
gsed -i -e "s|ALN_DIR|$A_ALN_DIR|g" -e "s|WD|$WD|g" BFparameters.txt
#####
...
mv ../loci_baits.txt .
$BaitFisher_Path/BaitFilter-v1.0.6 -i loci_baits.txt -m thin-b --thinning-step-width 40 -o prefil_baits.txt 
...
$BaitFisher_Path/BaitFilter-v1.0.6 -i prefil_baits.txt -c four-column-upload -o prefasta.txt 1> finalstats.txt
...
rm loci_baits.txt
#mv baits file to main directory
mv baits.fasta $WD
